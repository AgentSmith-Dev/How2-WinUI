...
namespace winrt::How2_PropertyChange_DataBinding::implementation
{
    ...
    */
    ...
    winrt::How2_PropertyChange_DataBinding::clWinUIRNA clWinUIControl_RNAList::GetWinUIRNA_Page_Property()
    {
        return  this->m_WinUIRNA;
    }

    void clWinUIControl_RNAList::GetWinUIRNA_Page_Property(winrt::How2_PropertyChange_DataBinding::clWinUIRNA const& value)
    {
