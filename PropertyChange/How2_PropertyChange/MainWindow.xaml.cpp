...
*/
    ...
    */
    ...
    winrt::How2_PropertyChange_DataBinding::clWinUIRNA MainWindow::GetWinUIRNA_Window_Property()
    {
    ...
    */
    //  ------------------------------------------------------------------------------------------------------
    void winrt::How2_PropertyChange_DataBinding::implementation::MainWindow::OnBtnClearRNA_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
    {
        sender; 
        e;
