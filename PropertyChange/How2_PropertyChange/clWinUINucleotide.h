...
namespace winrt::How2_PropertyChange_DataBinding::implementation
{
    struct clWinUINucleotide : clWinUINucleotideT<clWinUINucleotide>
    {
        ...
        clWinUINucleotide(winrt::How2_PropertyChange_DataBinding::enNucleotide_Type const& _enNucleotide_Type);
...
*/
        winrt::How2_PropertyChange_DataBinding::enNucleotide_Type enNucleotide_Type_Property();
                                                    void    enNucleotide_Type_Property(winrt::How2_PropertyChange_DataBinding::enNucleotide_Type const& value);
