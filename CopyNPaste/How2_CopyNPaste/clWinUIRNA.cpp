...
namespace winrt::How2_CopyNPaste::implementation
{
    ...
    */
    ...
    clWinUIRNA::clWinUIRNA()
    {
        ...
        m_obsvecRNA = winrt::single_threaded_observable_vector<winrt::How2_CopyNPaste::clWinUINucleotide>();
    }
    ...
    */
    ...
    {
        winrt::How2_CopyNPaste::clWinUINucleotide xNucleotide = nullptr;

        switch (wcSymbol)
        {
        case 'A':
            xNucleotide = winrt::make<How2_CopyNPaste::implementation::clWinUINucleotide>(enNucleotide_Type::Adenine);
            break;
        case 'C':
            xNucleotide = winrt::make<How2_CopyNPaste::implementation::clWinUINucleotide>(enNucleotide_Type::Cytosine);
            break;
        case 'G':
            xNucleotide = winrt::make<How2_CopyNPaste::implementation::clWinUINucleotide>(enNucleotide_Type::Guanine);
            break;
        case 'U':
            xNucleotide = winrt::make<How2_CopyNPaste::implementation::clWinUINucleotide>(enNucleotide_Type::Uracil);
            break;
		case 'T':
            xNucleotide = winrt::make<How2_CopyNPaste::implementation::clWinUINucleotide>(enNucleotide_Type::Thymine);
            break;
        default:
            // Handle invalid nucleotide
            xNucleotide = winrt::make<How2_CopyNPaste::implementation::clWinUINucleotide>(enNucleotide_Type::None);
            break;
        }
    ...
    */
    //  ------------------------------------------------------------------------------------------------------
    winrt::Windows::Foundation::Collections::IObservableVector<winrt::How2_CopyNPaste::clWinUINucleotide> clWinUIRNA::Get_obsvecRNA_Property()
    {
