...
namespace winrt::How2_CopyNPaste::implementation
{
    struct clWinUIRNA : clWinUIRNAT<clWinUIRNA>
    {
        ...
        winrt::Windows::Foundation::Collections::IObservableVector<winrt::How2_CopyNPaste::clWinUINucleotide> Get_obsvecRNA_Property();
    ...
    private:
		winrt::Windows::Foundation::Collections::IObservableVector<winrt::How2_CopyNPaste::clWinUINucleotide> m_obsvecRNA;
