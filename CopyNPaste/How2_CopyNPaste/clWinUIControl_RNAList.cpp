...
namespace winrt::How2_CopyNPaste::implementation
{
    ...
    */
    ...
    winrt::How2_CopyNPaste::clWinUIRNA clWinUIControl_RNAList::GetWinUIRNA_Page_Property()
    {
        return  this->m_WinUIRNA;
    }

    void clWinUIControl_RNAList::GetWinUIRNA_Page_Property(winrt::How2_CopyNPaste::clWinUIRNA const& value)
    {
