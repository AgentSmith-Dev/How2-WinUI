...
namespace winrt::How2_PartII_DataTemplateSelector::implementation
{
    struct clWinUIRNA : clWinUIRNAT<clWinUIRNA>
    {
        ...
        winrt::Windows::Foundation::Collections::IObservableVector<winrt::How2_PartII_DataTemplateSelector::clWinUINucleotide> Get_obsvecRNA_Property();
    ...
    private:
		winrt::Windows::Foundation::Collections::IObservableVector<winrt::How2_PartII_DataTemplateSelector::clWinUINucleotide> m_obsvecRNA;
