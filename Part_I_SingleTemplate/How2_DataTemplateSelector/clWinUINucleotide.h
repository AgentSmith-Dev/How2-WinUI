...
namespace winrt::How2_DataTemplateSelector::implementation
{
    struct clWinUINucleotide : clWinUINucleotideT<clWinUINucleotide>
    {
        ...
        clWinUINucleotide(winrt::How2_DataTemplateSelector::enNucleotide_Type const& _enNucleotide_Type);

        winrt::How2_DataTemplateSelector::enNucleotide_Type enNucleotide_Type_Property();
                                                    void    enNucleotide_Type_Property(winrt::How2_DataTemplateSelector::enNucleotide_Type const& value);
