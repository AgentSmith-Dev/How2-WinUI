...
namespace winrt::How2_DataTemplateSelector::implementation
{
    ...
    */
    ...
    winrt::How2_DataTemplateSelector::clWinUIRNA clWinUIControl_RNAList::GetWinUIRNA_Page_Property()
    {
        return  this->m_WinUIRNA;
    }

    void clWinUIControl_RNAList::GetWinUIRNA_Page_Property(winrt::How2_DataTemplateSelector::clWinUIRNA const& value)
    {
