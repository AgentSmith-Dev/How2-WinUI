...
namespace winrt::How2_DataTemplateSelector::implementation
{
    struct clWinUIControl_RNAList : clWinUIControl_RNAListT<clWinUIControl_RNAList>
    {
        ...
        winrt::How2_DataTemplateSelector::clWinUIRNA GetWinUIRNA_Page_Property();
        void GetWinUIRNA_Page_Property(winrt::How2_DataTemplateSelector::clWinUIRNA const& value);
...
*/
    protected:
        winrt::How2_DataTemplateSelector::clWinUIRNA  m_WinUIRNA=nullptr;
