...
namespace winrt::How2_DataTemplateSelector::implementation
{
    ...
    */
    ...
    clWinUINucleotide::clWinUINucleotide(winrt::How2_DataTemplateSelector::enNucleotide_Type const& _enNucleotide_Type)
    {
    ...
    */
    //  ------------------------------------------------------------------------------------------------------
    winrt::How2_DataTemplateSelector::enNucleotide_Type clWinUINucleotide::enNucleotide_Type_Property()
    {
        return  m_enNucleotide_Type;
    }
    void clWinUINucleotide::enNucleotide_Type_Property(winrt::How2_DataTemplateSelector::enNucleotide_Type const& value)
    {
    ...
    */
    ...
    hstring clWinUINucleotide::hstrSymbol_Property()
    {
        ...
        if (!m_pNucleotide) {
            ...
            wchar_t symbol = m_pNucleotide->wcGetSymbol();  
            hstrSymbol = winrt::hstring(&symbol, 1);        
