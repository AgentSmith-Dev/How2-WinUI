...
namespace winrt::How2_PropertyChange_II::implementation
{
    ...
    */
    ...
    clWinUINucleotide::clWinUINucleotide(winrt::How2_PropertyChange_II::enNucleotide_Type const& _enNucleotide_Type)
    {
    ...
    */
    //  ------------------------------------------------------------------------------------------------------
    winrt::How2_PropertyChange_II::enNucleotide_Type clWinUINucleotide::enNucleotide_Type_Property()
    {
        return  m_enNucleotide_Type;
    }
    void clWinUINucleotide::enNucleotide_Type_Property(winrt::How2_PropertyChange_II::enNucleotide_Type const& value)
    {
